...
#define PLUGIN2                 autoClose //    OFF, Specify the class instance (same as plugin directory name) to enable.    Option
#include "AutoClose/AutoClose.h"          //         Specify the header file to include the class.
