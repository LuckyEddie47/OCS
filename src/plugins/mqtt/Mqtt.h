...
#define MQTT_BROKER_HOST                  "192.168.7.215" //    "...", MQTT broker IP address or hostname.                     Option
...
#define MQTT_USERNAME                               "ocs" //    "onstep", MQTT username for authentication (empty "" = none).  Option
#define MQTT_PASSWORD                        "triangulum" //    "password", MQTT password for authentication (empty "" = none). Option

#define MQTT_TOPIC_COMMAND     MQTT_DEVICE_ID "/cmd"      //    MQTT_DEVICE_ID "/cmd", Topic to receive commands.       Option
#define MQTT_TOPIC_RESPONSE    MQTT_DEVICE_ID "/response" //    MQTT_DEVICE_ID "/response", Topic to publish responses. Option
#define MQTT_TOPIC_ECHO        MQTT_DEVICE_ID "/echo"     //    MQTT_DEVICE_ID "/echo", Topic to echo all commands.     Option
#define MQTT_TOPIC_STATUS      MQTT_DEVICE_ID "/status"   //    MQTT_DEVICE_ID "/status", Topic for online/offline.     Option
